...
# (Optional) Disable use of Redfish protocol to administer hosts; use IPMI instead.
# This may be needed if host firmware does not correctly support our use of
# Redfish.
# Default value is False.
#disable_redfish_administration=True
